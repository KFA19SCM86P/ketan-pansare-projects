		...
		try
         {  
           response.setContentType("text/html");
			...
			pw.print("<h2>Add Product Section</h2>");
			
			utility.printHtml("AddProduct.html");
			
			pw.print("<h2>Remove Product Section</h2>");
			
			utility.printHtml("RemoveProduct.html");
			
			pw.print("<h2>Edit Product Section</h2>");
			
			utility.printHtml("EditProduct.html");
