...
public class WList extends HttpServlet {
	...
	/* Checks the Wirelesss type whether it is microsft or apple or samsung */
		...
		{
			hm.putAll(MySqlDataStoreUtilities.selectWl());
			name = "";
		} 
		else 
		{
			...
			{	
				for(Map.Entry<String,Wireless> entry : MySqlDataStoreUtilities.selectWl().entrySet())
				{
		...
		for (Map.Entry<String, Wireless> entry : hm.entrySet()) {
			...
			pw.print("<li><form method='post' action='WriteReview'>"+"<input type='hidden' name='name' value='"+Wireless.getName()+"'>"+
					"<input type='hidden' name='type' value='wirelesss'>"+
					"<input type='hidden' name='maker' value='"+CategoryName+"'>"+
					"<input type='hidden' name='access' value=''>"+
					"<input type='hidden' name='price' value='"+Wireless.getPrice()+"'>"+
				    "<input type='submit' value='WriteReview' class='btnreview'></form></li>");
			pw.print("<li><form method='post' action='ViewReview'>"+"<input type='hidden' name='name' value='"+Wireless.getName()+"'>"+
					"<input type='hidden' name='type' value='wirelesss'>"+
					"<input type='hidden' name='maker' value='"+CategoryName+"'>"+
					"<input type='hidden' name='access' value=''>"+
