...
public class WearList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(CategoryName==null){
			hm.putAll(MySqlDataStoreUtilities.selectWear());
			name = "";
		}
		else
		{
		   ...
		   {
			 for(Map.Entry<String,Wear> entry : MySqlDataStoreUtilities.selectWear().entrySet())
			 {
		...
		for(Map.Entry<String, Wear> entry : hm.entrySet())
		{
			...
			pw.print("<li><form method='post' action='WriteReview'>"+"<input type='hidden' name='name' value='"+wear.getName()+"'>"+
					"<input type='hidden' name='type' value='wears'>"+
					"<input type='hidden' name='maker' value='"+CategoryName+"'>"+
					"<input type='hidden' name='access' value=''>"+
					"<input type='hidden' name='price' value='"+wear.getPrice()+"'>"+
				    "<input type='submit' value='WriteReview' class='btnreview'></form></li>");
			pw.print("<li><form method='post' action='ViewReview'>"+"<input type='hidden' name='name' value='"+wear.getName()+"'>"+
					"<input type='hidden' name='type' value='wears'>"+
					"<input type='hidden' name='maker' value='"+CategoryName+"'>"+
					"<input type='hidden' name='access' value=''>"+
