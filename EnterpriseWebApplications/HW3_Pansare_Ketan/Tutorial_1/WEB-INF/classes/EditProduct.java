...
public class EditProduct extends HttpServlet {	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MySqlDataStoreUtilities.editProduct(id,name,Double.parseDouble(price),image,maker,condition,Double.parseDouble(discount),category);
		
		utility.printHtml("Header.html");
		utility.printHtml("LeftNavigationBar.html");
		pw.print("<div id='content'><div class='post'><h2 class='title meta'>");
		pw.print("<a style='font-size: 24px;'>Status</a>");
		pw.print("<h2> Edited Product with ID  :"+id+"</h2>");
		pw.print("</div></div>");		
