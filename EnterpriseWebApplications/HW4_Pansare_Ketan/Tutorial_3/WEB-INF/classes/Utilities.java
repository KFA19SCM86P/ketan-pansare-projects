...
public class Utilities extends HttpServlet{
	...
	public void storeProduct(String name,String type,String maker, String acc){
		...
		if(type.equals("consoles")){
			...
			OrderItem orderitem = new OrderItem(console.getName(), console.getPrice(), console.getImage(), console.getRetailer(),type);
		...
		if(type.equals("games")){
			...
			OrderItem orderitem = new OrderItem(game.getName(), game.getPrice(), game.getImage(), game.getRetailer(),type);
			orderItems.add(orderitem);
		}
		if(type.equals("sounds")){
			...
			sound = allsounds.get(name);
			OrderItem orderitem = new OrderItem(sound.getName(), sound.getPrice(), sound.getImage(), sound.getRetailer(),type);
			orderItems.add(orderitem);
		}
		...
		if(type.equals("laptops")){
			...
			OrderItem orderitem = new OrderItem(laptop.getName(), laptop.getPrice(), laptop.getImage(), laptop.getRetailer(),type);
			orderItems.add(orderitem);
		}
		...
		if(type.equals("tablets")){
			...
			OrderItem orderitem = new OrderItem(tablet.getName(), tablet.getPrice(), tablet.getImage(), tablet.getRetailer(),type);
			orderItems.add(orderitem);
		}
	...
	public void storePayment(int orderId,
		String orderName,double orderPrice,String userAddress,String creditCardNo,String customer,String customerAge,String customerCity, String customerStreet, String customerZip,String deliveryType, String deliveryLocation,String expectedDate,String retailerName,String retType){
		HashMap<Integer, ArrayList<OrderPayment>> orderPayments= new HashMap<Integer, ArrayList<OrderPayment>>();
		...
		OrderPayment orderpayment = new OrderPayment(orderId,username(),orderName,orderPrice,userAddress,creditCardNo,customerAge,customerCity,customerStreet,customerZip,deliveryType,deliveryLocation,expectedDate,retailerName,retType);
		...
		{	if(session.getAttribute("usertype").equals("retailer"))
			{
				MySqlDataStoreUtilities.insertOrder(orderId,customer,orderName,orderPrice,userAddress,creditCardNo,customerAge,customerCity,customerStreet,customerZip,deliveryType,deliveryLocation,expectedDate,retailerName,retType);
			}else
				
				{MySqlDataStoreUtilities.insertOrder(orderId,username(),orderName,orderPrice,userAddress,creditCardNo,customerAge,customerCity,customerStreet,customerZip,deliveryType,deliveryLocation,expectedDate,retailerName,retType);}
		}
		catch(Exception e)
		{
     ...
     public String storeReview(String productname,String producttype,String productmaker,String reviewrating,String reviewdate,String reviewtext,String reatilerpin,String price,String city,String retailerstate,String productsale,String manuname,String rebate,String uid,String userage,String usergender,String userocc){
	String message=MongoDBDataStoreUtilities.insertReview(productname,username(),producttype,productmaker,reviewrating,reviewdate,reviewtext,reatilerpin,price,city,retailerstate,productsale,manuname,rebate,uid,userage,usergender,userocc);
		...
		Review review = new Review(productname,username(),producttype,productmaker,reviewrating,reviewdate,reviewtext,reatilerpin,price,city,retailerstate,productsale,manuname,rebate,uid,userage,usergender,userocc);
	...
	public ArrayList<String> getProductsSounds(){		
		ArrayList<String> ar = new ArrayList<String>();
		for(Map.Entry<String, Sound> entry : getSounds().entrySet()){
			ar.add(entry.getValue().getName());
		}
		return ar;
	}
