	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='consoles' selected>Tv's</option><option value='games'>Voice Assistant</option><option value='tablets'>Phones</option><option value='sounds'>Sound Systems</option><option value='laptops'>Laptop</option><option value='accessories'>Accessory</option></select>"
					+ "</td></tr><tr><td>"
		...
		}else if (action.equals("Updateproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					+ "<table id='bestseller'><tr><td>"
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='consoles' selected>Console</option><option value='games'>Games</option><option value='tablets'>Tablet</option><option value='sounds'>Sound-Systems</option><option value='laptops'>Lapop</option><option value='accessories'>Accessory</option></select>"
					+ "</td></tr><tr><td>"
					+ "<h3>Product Id</h3></td><td><input type='text' name='productId' value='' class='input' required></input>"
					+ "</td></tr><tr><td>"
					+ "<h3>Product Name</h3></td><td><input type='text' name='productName' value='' class='input' required></input>"
