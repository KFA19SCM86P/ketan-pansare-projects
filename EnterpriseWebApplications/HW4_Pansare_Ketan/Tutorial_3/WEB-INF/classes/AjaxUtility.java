...
public class AjaxUtility {
	...
	public static void storeData(HashMap<String,Product> productdata)
	{
		try
		{
			...
			String insertIntoProductQuery = "INSERT INTO product(productId,productName,image,retailer,productCondition,productPrice,productType,discount,inventory) "
			+ "VALUES (?,?,?,?,?,?,?,?,?);";	
			...
			{	
				...
				pst.setInt(8,entry.getValue().getInventory());
				pst.execute();
			}
		}
		catch(Exception e)
