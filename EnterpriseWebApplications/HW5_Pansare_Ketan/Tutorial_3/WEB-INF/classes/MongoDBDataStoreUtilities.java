	...
	while (cursor.hasNext())
	{
		   ...
		   if(!reviews.containsKey(obj.getString("productName")))
			...
			Review review =new Review(obj.getString("productName"),obj.getString("userName"),obj.getString("productType"),obj.getString("productMaker"),
				obj.getString("reviewRating"),obj.getString("reviewDate"),obj.getString("reviewText"),obj.getString("retailerpin"),obj.getString("price"),obj.getString("retailercity"),obj.getString("retailerstate"),obj.getString("productsale"), obj.getString("manuname"),obj.getString("rebate"),obj.getString("uid"),obj.getString("userage"),obj.getString("usergender"),obj.getString("userocc"));
