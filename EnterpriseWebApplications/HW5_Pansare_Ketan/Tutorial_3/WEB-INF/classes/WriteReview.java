		...
		pw.print("<input type='hidden' name='productmaker' value='"+productmaker+"'>");
                pw.print("</td></tr><table>");
  				...
  				pw.print("<table><tr></tr><tr></tr><tr><td> Review Rating: </td>");
					...
					pw.print("<table><tr></tr><tr></tr><tr><td> Product in Sale: </td>");
					pw.print("<td>");
						pw.print("<select name='productsale'>");
					...
					pw.print("<td> <input type='text' name='manuname'> </td>");
			        pw.print("</tr>");
					
					pw.print("<table><tr></tr><tr></tr><tr><td> Manufacturer Rebate: </td>");
					pw.print("<td>");
					...
					pw.print("<td> <input type='text' name='uid'> </td>");
			        pw.print("</tr>");	
					...
					pw.print("<td> <input type='text' name='userocc'> </td>");
			        pw.print("</tr>");	
