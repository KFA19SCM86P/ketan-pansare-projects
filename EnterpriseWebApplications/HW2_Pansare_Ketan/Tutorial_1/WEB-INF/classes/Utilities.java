...
public class Utilities extends HttpServlet{
				...
				result = result + "<li><a href='ViewOrder'><span class='glyphicon'>ViewOrder</span></a></li>"
						...
						"<button class=\"dropbtn\">Action</button>"+
							...
							if(userrole.equals("retailer")){
								result = result +"<a href=\"Actions\">Manage-Prod.</a>";
								//result = result +"<a href=\"DataAnalytics\">Data Analytics</a>";
								//result = result +"<a href=\"ViewData\">Top-N-Search</a>";
								//result = result +"<a href=\"DataVisualization\">Data Visulization</a>";
							}else if(userrole.equals("manager")){
								result = result +"<a href=\"ActionsSales\">Cancel Orders</a>";
								result = result +"<a href=\"ActionsSalesEdit\">Edit Orders</a>";
							}
	...
	public User getUser(){
		...
		HashMap<String, User> hm=MySqlDataStoreUtilities.selectUser();
	...
	public void storePayment(int orderId,
		String orderName,double orderPrice,String userAddress,String creditCardNo, String cstreet, String ccity, String cstate, String czipcode){
		...
		OrderPayment orderpayment = new OrderPayment(orderId,username(),orderName,orderPrice,userAddress,creditCardNo,cstreet,ccity,cstate,czipcode);
	...
	public String storeReview(String productname,String producttype,String productmaker,String reviewrating,String reviewdate,String  reviewtext,String reatilerpin,String price,String city,String age,String gender,String occupation){
		String message=MongoDBDataStoreUtilities.insertReview(productname,username(),producttype,productmaker,reviewrating,reviewdate,reviewtext,reatilerpin,price,city,age,gender,occupation);
		...
		Review review = new Review(productname,username(),producttype,productmaker,reviewrating,reviewdate,reviewtext,reatilerpin,price,city,age,gender,occupation);
