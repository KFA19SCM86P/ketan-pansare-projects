...
public static void insertOrder(int orderId,String userName,String orderName,double orderPrice,String userAddress,String creditCardNo, String cstreet, String ccity, String cstate, String czipcode)
{
	try
	{
	
		getConnection();
		String insertIntoCustomerOrderQuery = "INSERT INTO customerOrders(OrderId,UserName,OrderName,OrderPrice,userAddress,creditCardNo, cstreet, ccity, cstate, czipcode) "
		+ "VALUES (?,?,?,?,?,?,?,?,?,?);";	
		...
		pst.setString(7,cstreet);
		pst.setString(8,ccity);
		pst.setString(9,cstate);
		pst.setString(10,czipcode);
		pst.execute();
	}
	catch(Exception e)
	{
...
{	
	...
	{					
		...
		while(rs.next())
		{
			...
			OrderPayment order= new OrderPayment(rs.getInt("order_id"),rs.getString("u_name"),rs.getString("p_name"),rs.getDouble("price"),rs.getString("address"),rs.getString("credit_no"), rs.getString("cstreet"), rs.getString("ccity"), rs.getString("cstate"), rs.getString("czipcode"));
...
public static void saveProduct(int order_id,String u_name,String p_name,double price,String credit_no,String address,String o_date,String d_date, String cstreet, String ccity, String cstate, String czipcode)
{
	try
	{	

		getConnection();
		String saveProduct = "INSERT INTO orders(order_id,u_name,p_name,price,credit_no,address,o_date,d_date,cstreet,ccity,cstate,czipcode) "
		+ "VALUES (?,?,?,?,?,?,?,?,?,?,?,?);";	
		...
		pst.setString(9,cstreet);
		pst.setString(10,ccity);
		pst.setString(11,cstate);
		pst.setString(12,czipcode);
		pst.execute();
	}
	catch(Exception e)
	{
...
public static void saveCustomerAddress(int order_id,String u_name,String cstreet, String ccity, String cstate, String czipcode)
{
	try
	{	

		getConnection();
		String saveCustomerAddress = "INSERT INTO address(order_id,u_name,cstreet,ccity,cstate,czipcode)"
		+ "VALUES (?,?,?,?,?,?);";	
				
		PreparedStatement pst = conn.prepareStatement(saveCustomerAddress);
		pst.setInt(1,order_id);
		pst.setString(2,u_name);
		pst.setString(3,cstreet);
		pst.setString(4,ccity);
		pst.setString(5,cstate);
		pst.setString(6,czipcode);
		pst.execute();
	}
	catch(Exception e)
	{
