...
public class CheckOut extends HttpServlet {
	...
	protected void storeOrders(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<td><input type='text' name='cname'>");
        pw.print("</td></tr>");
        pw.print("<tr><td>");
        ...
        pw.print("<tr><td>");
	    pw.print("Street</td>");
		pw.print("<td><input type='text' name='cstreet'>");
        pw.print("</td></tr>");
        pw.print("<tr><td>");
	    pw.print("City</td>");
		pw.print("<td><input type='text' name='ccity'>");
        pw.print("</td></tr>");
        pw.print("<tr><td>");
	    pw.print("State</td>");
		pw.print("<td><input type='text' name='cstate'>");
        pw.print("</td></tr>");
        pw.print("<tr><td>");
	    pw.print("Zip code</td>");
		pw.print("<td><input type='text' name='czipcode'>");
        pw.print("</td></tr>");
  ...
  "<select name='cars' id='cars'>"+
    "<option value='mumbai'>IOWA</option>"+
    "<option value='chicago'>INDIAN</option>"+
    "<option value='LA'>UTAH</option>"+
    "<option value='Vegas'>NYC</option>"+
    "<option value='Newyork'>Illinois</option>"+
    "<option value='utah'>Maine</option>"+
    "<option value='sanjose'>Wisconsin</option>"+
    "<option value='sandiego'>California</option>"+
    "<option value='cali'>Arizona</option>"+
    "<option value='portland'>Texas</option>"+
    "<option value='maine'>Kansas</option>"+
  "</select>");
