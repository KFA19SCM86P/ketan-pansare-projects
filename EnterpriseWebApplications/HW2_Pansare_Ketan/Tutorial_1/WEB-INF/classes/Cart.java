	...
	protected void displayCart(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{	
			...
			{		
						...
						pw.print("<tr>");
						pw.print("<td><form name ='Cart1' action='Cart' method='get'><input type='hidden' name='orderName' value='"+oi.getName()+"'><input type='submit' name='RemoveItem' value='Remove' class='btnbuy'></form></td>");
